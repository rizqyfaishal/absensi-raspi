...
while True:
    ...
    response = requests.request("POST", "http://absensikampus.herokuapp.com/absensi/forward-data",data=json.dumps({"mac_address":mac_address, "ruangan":"K301", "timestamp_raspi": str(time.strftime())}))
